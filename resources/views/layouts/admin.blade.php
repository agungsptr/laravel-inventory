                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item has-treeview menu-open mb-4">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('category.index') }}" class="nav-link @yield('menu-kategori-daftar')">
                                        <i class="fas fa-list nav-icon"></i>
                                        <p>Daftar Kategori</p>
                                    </a>
                                </li>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('category.create') }}" class="nav-link @yield('menu-kategori-tambah')">
                                        <i class="fas fa-plus nav-icon"></i>
                                        <p>Tambah Kategori</p>
                                    </a>
                                </li>
