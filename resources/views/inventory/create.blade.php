                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input name="name" type="text"
                            class=" form-control {{$errors->first('name') ? 'is-invalid':''}}" value="{{old('name')}}"
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input name="brand" type="text"
                            class=" form-control {{$errors->first('brand') ? 'is-invalid':''}}" value="{{old('brand')}}"
                            maxlength="190" minlength="" required>
                        @error('brand')
                        <div class="invalid-feedback">
                            {{$message}}
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input name="amount" type="text" onkeypress="isInputNumber(event)"
                            ...
                            value="{{old('amount')}}" maxlength="190" minlength="" required>
                        @error('amount')
                        <div class="invalid-feedback">
                            {{$message}}
                        </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input name="location" type="text"
                            ...
                            value="{{old('location')}}" maxlength="190" minlength="" required>
                        @error('location')
                        <div class="invalid-feedback">
                            {{$message}}
                        </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input name="condition" type="text"
                            class=" form-control {{$errors->first('condition') ? 'is-invalid':''}}"
                            value="{{old('condition')}}" maxlength="190" minlength="" required>
                        @error('condition')
                        <div class="invalid-feedback">
                            {{$message}}
                        </div>
