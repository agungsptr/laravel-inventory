...
<div class="row">
    <div class="col-12">
        ...
        <form action="{{ route('inventory.update', ['inventory'=>$inv->id]) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-sm-6">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input name="name" type="text"
                            class=" form-control {{$errors->first('name') ? 'is-invalid':''}}" value="{{$inv->name}}"
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="category_id" id="" required>
                            ...
                            <option value="{{$ctg->id}}" {{$inv->category_id == $ctg->id ? 'selected':''}}>
                                {{$ctg->name}}
                            </option>
                            @endforeach
                        </select>
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input name="brand" type="text"
                            class=" form-control {{$errors->first('brand') ? 'is-invalid':''}}" value="{{$inv->brand}}"
                            maxlength="190" minlength="" required>
                        @error('brand')
                        <div class="invalid-feedback">
                            {{$message}}
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input name="amount" type="text" onkeypress="isInputNumber(event)"
                            ...
                            value="{{$inv->amount}}" maxlength="190" minlength="" required>
                        @error('amount')
                        <div class="invalid-feedback">
                            {{$message}}
                        </div>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="datetime-local" class="form-control {{$errors->first('buy_date') ? 'is-invalid':''}}"
                            name="buy_date" value="{{str_replace(" ","T", $inv->buy_date)}}">
                        @error('buy_date')
                        <div class="invalid-feedback">
                            {{$message}}
                        </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="status" id="" required>
                            ...
                            <option value="TIDAK TERPAKAI" {{$inv->status == "TIDAK_TERPAKAI" ? 'selected':''}}>Tidak Terpakai
                            </option>
                        </select>
                    </div>
                </div>
